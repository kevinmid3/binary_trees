 ...
 *
 * @tree: tree root
 * Return: This returns the height of the tree or 0 if tree is NULL;
 */
...
/**
 * binary_tree_balance - This calls recursive_balance to return the balance
 * of a binary tree
 *
 * @tree: tree root
 * Return:This returns the balance factor of the tree or 0 if tree is NULL;
 */
