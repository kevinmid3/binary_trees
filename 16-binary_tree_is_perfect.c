 ...
 *
 * @node: pointer points to the node to check
 * Return:This returns 1 if node is a leaf, otherwise 0
 */
...
/**
 * binary_tree_is_parent_full - This will check if a node is a parent
 *
 * @node: pointer to the node to check
 * Return:This returns 1 if node is a parent, otherwise 0
 */
